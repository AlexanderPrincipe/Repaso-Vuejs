    ...
    <div class="mt-5">
        ...
        <b-row class="mt-5">
            <b-col cols="12" md="4">
                ...
                img-top=""
                >
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellendus minus deleniti cupiditate. Maiores suscipit aperiam in quisquam distinctio doloremque eveniet qui illum commodi autem, atque iure mollitia quam, veritatis similique.</p>
